...
@on_message("setwelcome", allow_master=True)
...
@on_message("delwelcome", allow_master=True)
...
@on_message("goodbye", allow_master=True)
...
@on_message("setgoodbye", allow_master=True)
...
@on_message("delgoodbye", allow_master=True)
