...
async def draw_meme(
    ...
    font = ImageFont.truetype("./zelretch/resources/fonts/Montserrat.ttf", font_size)
...
async def create_calendar(year: int, month: int) -> str:
    ...
    month_font = ImageFont.truetype("./zelretch/resources/fonts/Montserrat.ttf", 40)
    month_x = (
    ...
    week_font = ImageFont.truetype("./zelretch/resources/fonts/Montserrat.ttf", 23)
    ...
    font = ImageFont.truetype("./zelretch/resources/fonts/Montserrat.ttf", 30)
